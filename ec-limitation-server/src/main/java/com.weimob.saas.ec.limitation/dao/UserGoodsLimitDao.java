...
public interface UserGoodsLimitDao {
    ...
    /**
     * @title 批量删除查询用户活动购买记录（所有pid,storeId,limitId下的）
     * @author fei.zheng
     * @date 2018/10/31 10:06
     * @parameterExample
     * @returnExample
     */
    Integer deleteUserGoodsLimitListByWid(List<UserGoodsLimitEntity> userGoodsLimitEntityList);
    ...
    List<UserGoodsLimitEntity> listUserGoodsLimitByGoodsIdList(CommonLimitParam commonLimitParam);
}