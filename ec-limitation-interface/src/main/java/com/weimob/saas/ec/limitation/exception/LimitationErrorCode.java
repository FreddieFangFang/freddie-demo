...
public enum LimitationErrorCode {
    ...
    PART_ACTIVITY_EXPIRED("1080020200012", "部分活动已失效，请重新下单", "部分活动已失效，请重新下单"),
    PART_GOODS_EXPIRED("1080020200013", "部分商品已失效，请重新下单", "部分商品已失效，请重新下单"),
    PART_SKU_EXPIRED("1080020200014", "部分商品规格已失效，请重新下单", "部分商品规格已失效，请重新下单"),
